...
func rmAllocInvoke[Params any](fi *frontendIoctlState, ioctlParams *nvgpu.NVOS64ParametersR535, allocParams *Params, isNVOS64 bool, isR535 bool) (uintptr, error) {
	defer runtime.KeepAlive(allocParams) // since we convert to non-pointer-typed P64

	sentryIoctlParams := nvgpu.GetRmAllocParamType(isNVOS64, isR535)
	sentryIoctlParams.FromOS64R535(*ioctlParams)
