...
type RmAllocParamType interface {
	...
	FromOS64R535(other NVOS64ParametersR535)
	ToOS64R535() NVOS64ParametersR535
	GetPointer() uintptr
	marshal.Marshallable
}

// GetRmAllocParamType returns the appropriate implementation of
// RmAllocParamType based on passed parameters.
func GetRmAllocParamType(isNVOS64 bool, isR535 bool) RmAllocParamType {
	if isNVOS64 {
		if isR535 {
			return &NVOS64ParametersR535{}
		}
		return &NVOS64Parameters{}
	}
	if isR535 {
		return &NVOS21ParametersR535{}
	}
...
// FromOS64R535 implements RmAllocParamType.FromOS64R535.
func (n *NVOS21Parameters) FromOS64R535(other NVOS64ParametersR535) {
	n.HRoot = other.HRoot
...
// ToOS64R535 implements RmAllocParamType.ToOS64R535.
func (n *NVOS21Parameters) ToOS64R535() NVOS64ParametersR535 {
	return NVOS64ParametersR535{
		HRoot:         n.HRoot,
...
// NVOS21ParametersR535 is the updated version of NVOS21Parameters starting
// from 535.43.02.
//
// +marshal
type NVOS21ParametersR535 struct {
	HRoot         Handle
	HObjectParent Handle
	HObjectNew    Handle
	HClass        uint32
...
// GetPAllocParms implements RmAllocParamType.GetPAllocParms.
func (n *NVOS21ParametersR535) GetPAllocParms() P64 {
	return n.PAllocParms
}

// GetPRightsRequested implements RmAllocParamType.GetPRightsRequested.
func (n *NVOS21ParametersR535) GetPRightsRequested() P64 {
	return 0
}

// SetPAllocParms implements RmAllocParamType.SetPAllocParms.
func (n *NVOS21ParametersR535) SetPAllocParms(p P64) { n.PAllocParms = p }

// SetPRightsRequested implements RmAllocParamType.SetPRightsRequested.
func (n *NVOS21ParametersR535) SetPRightsRequested(p P64) {
	panic("impossible")
}

// FromOS64R535 implements RmAllocParamType.FromOS64R535.
func (n *NVOS21ParametersR535) FromOS64R535(other NVOS64ParametersR535) {
	n.HRoot = other.HRoot
	n.HObjectParent = other.HObjectParent
	n.HObjectNew = other.HObjectNew
	n.HClass = other.HClass
...
// ToOS64R535 implements RmAllocParamType.ToOS64R535.
func (n *NVOS21ParametersR535) ToOS64R535() NVOS64ParametersR535 {
	return NVOS64ParametersR535{
		HRoot:         n.HRoot,
		HObjectParent: n.HObjectParent,
		HObjectNew:    n.HObjectNew,
...
// FromOS64R535 implements RmAllocParamType.FromOS64R535.
func (n *NVOS64Parameters) FromOS64R535(other NVOS64ParametersR535) {
	n.HRoot = other.HRoot
	n.HObjectParent = other.HObjectParent
	n.HObjectNew = other.HObjectNew
	n.HClass = other.HClass
...
// ToOS64R535 implements RmAllocParamType.ToOS64R535.
func (n *NVOS64Parameters) ToOS64R535() NVOS64ParametersR535 {
	return NVOS64ParametersR535{
		HRoot:            n.HRoot,
		HObjectParent:    n.HObjectParent,
		HObjectNew:       n.HObjectNew,
...
// NVOS64ParametersR535 is the updated version of NVOS64Parameters starting
// from 535.43.02.
//
// +marshal
type NVOS64ParametersR535 struct {
	HRoot            Handle
	HObjectParent    Handle
	HObjectNew       Handle
	HClass           uint32
...
// GetPAllocParms implements RmAllocParamType.GetPAllocParms.
func (n *NVOS64ParametersR535) GetPAllocParms() P64 {
	return n.PAllocParms
}

// GetPRightsRequested implements RmAllocParamType.GetPRightsRequested.
func (n *NVOS64ParametersR535) GetPRightsRequested() P64 {
	return n.PRightsRequested
}

// SetPAllocParms implements RmAllocParamType.SetPAllocParms.
func (n *NVOS64ParametersR535) SetPAllocParms(p P64) { n.PAllocParms = p }

// SetPRightsRequested implements RmAllocParamType.SetPRightsRequested.
func (n *NVOS64ParametersR535) SetPRightsRequested(p P64) { n.PRightsRequested = p }

// FromOS64R535 implements RmAllocParamType.FromOS64R535.
func (n *NVOS64ParametersR535) FromOS64R535(other NVOS64ParametersR535) { *n = other }

// ToOS64R535 implements RmAllocParamType.ToOS64R535.
func (n *NVOS64ParametersR535) ToOS64R535() NVOS64ParametersR535 { return *n }
...
var (
	...
	SizeofNVOS21ParametersR535        = uint32((*NVOS21ParametersR535)(nil).SizeBytes())
	...
	SizeofNVOS64ParametersR535        = uint32((*NVOS64ParametersR535)(nil).SizeBytes())
)
